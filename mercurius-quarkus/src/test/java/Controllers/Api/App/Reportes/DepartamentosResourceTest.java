...
/**
 * T19 smoke suite for {@link DepartamentosResource} (Reporte de Ventas por
 * Departamento): date-range round-trip, page + HX fragment renders, role gate.
 */
@QuarkusTest
class DepartamentosResourceTest {

    private static final String PAGE = "/app/reportes/articulos/departamentos";
    ...
    void paginaAutenticadaContieneTabla() {
        given()
                ...
                .body(containsString("reporte-departamentos"))
                .body(containsString("Departamento"));
    }
