...
/**
 * T19 smoke suite for {@link PreciosResource} (Histórico de Precios,
 * read-only): page + HX fragment renders, text filter round-trip, role gate.
 */
@QuarkusTest
class PreciosResourceTest {

    private static final String PAGE = "/app/reportes/inventario/precios";
    ...
    void paginaAutenticadaContieneTabla() {
        given()
                ...
                .body(containsString("reporte-precios"))
                .body(containsString("Utilidad %"));
    }
