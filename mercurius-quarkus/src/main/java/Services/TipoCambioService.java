...
public class TipoCambioService extends GService<TipoCambio> {
    ...
    private static final Logger LOG = Logger.getLogger(TipoCambioService.class);
            ...
            if (response.getStatus() == Response.Status.OK.getStatusCode()) {
                ...
                if (tipoCambio != null) {
                    saveTipoCambio(tipoCambio);
                                ...
                                LOG.warn("Failed to retrieve TipoCambio data from API. Response code: " + response.getStatus() + " | source=" + "TipoCambioService.getTipoCambioFromApi()" + " | antes=" + String.valueOf((Object) null) + " | despues=" + String.valueOf((Object) null));
            }
        } catch (RuntimeException e) {
                        LOG.warn("Error fetching TipoCambio from API: " + e.getMessage() + " | source=" + "TipoCambioService.getTipoCambioFromApi()" + " | antes=" + String.valueOf((Object) null) + " | despues=" + String.valueOf(e.getMessage()));
        }
    }
    ...
    private TipoCambio parseTipoCambio(@Nonnull String jsonResponse) {
        try {
            ...
            return tipoCambio;
                        ...
                        LOG.warn("Error parsing JSON response: " + e.getMessage() + " | source=" + "TipoCambioService.parseTipoCambio()" + " | antes=" + String.valueOf((Object) null) + " | despues=" + String.valueOf(e.getMessage()));
            return null;
        }
    }
    ...
    private boolean tipoCambioExistsForDate(@Nonnull LocalDateTime date) {
        try {
            ...
            return query.getSingleResult() > 0;
                        ...
                        LOG.warn("Error checking TipoCambio existence for date: " + e.getMessage() + " | source=" + "TipoCambioService.tipoCambioExistsForDate()" + " | antes=" + String.valueOf((Object) null) + " | despues=" + String.valueOf(e.getMessage()));
            return false;
        }
    }
    ...
    public TipoCambio getNewestTipoCambio() {
        try {
            ...
            return getNewestTipoCambioFromDb();
                        ...
                        LOG.warn("Error retrieving newest TipoCambio: " + e.getMessage() + " | source=" + "TipoCambioService.getNewestTipoCambio()" + " | antes=" + String.valueOf((Object) null) + " | despues=" + String.valueOf(e.getMessage()));
            throw e;
        }
    }
    ...
    public TipoCambio getNewestTipoCambioFallback() {
                LOG.warn("FALLBACK: Returning cached TipoCambio data due to API failure" + " | source=" + "TipoCambioService.getNewestTipoCambioFallback()" + " | antes=" + String.valueOf((Object) null) + " | despues=" + String.valueOf((Object) null));
        return getNewestTipoCambioFromDb();
    }
