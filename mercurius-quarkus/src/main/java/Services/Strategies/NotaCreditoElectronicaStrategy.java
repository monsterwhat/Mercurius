...
import Models.Documentos.NotaCreditoElectronicaDocumento;
...
public class NotaCreditoElectronicaStrategy implements DocumentoStrategy {
    ...
    @Inject
    public NotaCreditoElectronicaStrategy(EmisorService emisorService, ReceptorService receptorService) {
