...
public class FacturaExportacionElectronicaStrategy implements DocumentoStrategy {
    ...
    private static final Logger LOG = Logger.getLogger(FacturaExportacionElectronicaStrategy.class);
    ...
    static {
        ...
        try {
            ...
            LOG.error("Failed to initialize JAXBContext for FacturaExportacionElectronicaDocumento", e);
        }
        JAXB_CONTEXT = ctx;
    }
