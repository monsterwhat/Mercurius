...
public class FacturaElectronicaStrategy implements DocumentoStrategy {
    ...
    private static final Logger LOG = Logger.getLogger(FacturaElectronicaStrategy.class);
    ...
    static {
        ...
        try {
            ...
            LOG.error("Failed to initialize JAXBContext for FacturaElectronicaDocumento", e);
        }
        JAXB_CONTEXT = ctx;
    }
