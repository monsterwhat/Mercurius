...
public class InventariosPagesResource {
    ...
    @Inject @Nonnull @Location("pages/inventario/index") Template page;
    @GET public Response index() {
        try {
            ...
            LOG.log(Level.WARNING, "Error renderizando inventarios", e);
            return Response.ok("<html><body><h1>Inventarios</h1><p>Vista inventarios (placeholder)</p><a href=\"/Mercurius/app\">Inicio</a></body></html>").type(MediaType.TEXT_HTML_TYPE.withCharset("UTF-8")).build();
        }
    }
}
