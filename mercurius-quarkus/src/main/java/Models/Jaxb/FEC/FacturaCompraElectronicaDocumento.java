...
/**
 * JAXB root for FacturaElectronicaCompra (FEC).
 * <p>
 * Uses FEC wrapper types from {@link Models.Jaxb.FEC} for proper namespace
...
@Data
@XmlType(name = "FacturaElectronicaCompra", propOrder = {
    "encabezado",
    "detalleServicio",
    "otrosCargos",
    "resumen",
...
public class FacturaCompraElectronicaDocumento {
     ...
     * each base entity to its corresponding FEC wrapper type.
     */
