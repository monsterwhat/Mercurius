...
/**
 * JAXB root for FacturaElectronicaExportacion (FEE).
 * <p>
 * Uses FEE wrapper types from {@link Models.Jaxb.FEE} for proper namespace
 * qualification - namespace is inherited from {@code package-info.java}.
 * </p>
 */
@XmlRootElement(name = "FacturaElectronicaExportacion")
@XmlAccessorType(XmlAccessType.FIELD)
@Data
@XmlType(name = "FacturaElectronicaExportacion", propOrder = {
    "encabezado",
    "detalleServicio",
    "otrosCargos",
    "resumen",
...
public class FacturaExportacionElectronicaDocumento {
    ...
    public FacturaExportacionElectronicaDocumento() {}

    /**
     * Constructs from a {@link ComprobantesEmitidos} entity, converting
     * each base entity to its corresponding FEE wrapper type.
     */
    public FacturaExportacionElectronicaDocumento(ComprobantesEmitidos ce) {
