...
/**
 * JAXB root for Factura Electrónica (FE).
 * <p>
 * Uses FE wrapper types from {@link Models.Jaxb.FE} for proper namespace
...
@Data
@XmlType(name = "FacturaElectronica", propOrder = {
    "encabezado",
    "detalleServicio",
    "otrosCargos",
    "resumen",
...
public class FacturaElectronicaDocumento {
     ...
     * each base entity to its corresponding FE wrapper type.
     */
    public FacturaElectronicaDocumento(ComprobantesEmitidos ce) {
        ...
        if (ce.getDetalles().getOtrosCargos() != null && !ce.getDetalles().getOtrosCargos().isEmpty()) {
