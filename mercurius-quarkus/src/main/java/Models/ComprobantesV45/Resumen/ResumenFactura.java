...
package Models.ComprobantesV45.Resumen;
...
public class ResumenFactura {
    ...
    //TODO TOTALDESGLOSEIMPUESTO 1-1000
    @XmlElementWrapper(name = "TotalDesgloseImpuestos")
    @XmlElement(name = "TotalDesgloseImpuesto")
    @EqualsAndHashCode.Exclude
    @ToString.Exclude
    @OneToMany(mappedBy = "resumenFactura", orphanRemoval = true, fetch = FetchType.EAGER)
