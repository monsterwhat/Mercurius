...
/**
 * JAXB root for NotaCreditoElectronica (NC).
 * <p>
 * Uses NC wrapper types from {@link Models.Jaxb.NC} for proper namespace
...
@Data
@XmlType(name = "NotaCreditoElectronica", propOrder = {
    "encabezado",
    "detalleServicio",
    "otrosCargos",
    "resumen",
...
public class NotaCreditoElectronicaDocumento {
     ...
     * each base entity to its corresponding NC wrapper type.
     */
