...
/**
 * JAXB root for TiqueteElectronico (TE).
 * <p>
 * Uses TE wrapper types from {@link Models.Jaxb.TE} for proper namespace
...
@Data
@XmlType(name = "TiqueteElectronico", propOrder = {
    "encabezado",
    "detalleServicio",
    "otrosCargos",
    "resumen",
...
public class TiqueteElectronicoDocumento {
     ...
     * each base entity to its corresponding TE wrapper type.
     */
