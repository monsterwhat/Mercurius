...
public class NotaCreditoElectronicaStrategy implements DocumentoStrategy {
    ...
    public String buildXml(ComprobantesEmitidos comprobante) throws JAXBException {
        ...
        if (isVersion43(comprobante)) {
            LOG.info("NotaCreditoElectronicaStrategy: emitting v4.3 unflattened XML for adjustment of 4.3 original | clave=" + (comprobante.getEncabezado() != null ? comprobante.getEncabezado().getClave() : "null"));
