...
public enum CondicionImpuesto {
    ...
    CondicionImpuesto(String codigo, String descripcion) {
        this.codigo = codigo;
    ...
    public static CondicionImpuesto fromCodigo(String codigo) {
        for (CondicionImpuesto condicion : CondicionImpuesto.values()) {
