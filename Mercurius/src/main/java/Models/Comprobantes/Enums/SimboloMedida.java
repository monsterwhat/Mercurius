...
public enum SimboloMedida {
    ...
    SimboloMedida(String simbolo, String descripcion) {
    ...
    // Método estático para obtener un SimboloMedida a partir del símbolo
    public static SimboloMedida fromSimbolo(String simbolo) {
        for (SimboloMedida medida : SimboloMedida.values()) {
